    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          <Text style={[styles.title, { color: colors.text }]}>Join TaskFlow AI</Text>
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
            Create your local secure account and start organizing
          </Text>
        </View>
        ...
        <View style={[themeStyles.glassCard, styles.formCard]}>
          ...
          />
          {errors.username && <Text style={[styles.errorText, { color: colors.danger }]}>{errors.username.message}</Text>}

          {/* Email Input */}
          <Text style={[styles.label, { color: colors.text, marginTop: 16 }]}>Email Address</Text>
          <Controller
            control={control}
            name="email"
            rules={{
